...
/**
 * Penny-Scraper (Grundgerüst, NICHT verifiziert).
 *
 ...
 * Penny gehört wie REWE zur REWE Group - möglich, dass die Angebotsseite
 * technisch ähnlich aufgebaut ist (lohnt sich zuerst zu prüfen).
 *
...
export async function scrape(branchConfig) {
  const url = `https://www.penny.de/angebote/${encodeURIComponent(branchConfig.sucheParam)}` // TODO verifizieren
