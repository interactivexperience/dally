...
/**
 * Rossmann-Scraper (Grundgerüst, NICHT verifiziert).
 *
 ...
 * Rossmann ist wie dm eine Drogeriekette - möglich, dass Rossmann ähnlich
 * wie dm eher Kampagnen-/Aktions-Kacheln statt einer reinen Preis-Liste
 * zeigt (siehe dm.js). Zuerst prüfen, welcher Fall zutrifft.
 *
...
export async function scrape(branchConfig) {
  const url = `https://www.rossmann.de/de/angebote/index.html?searchterm=${encodeURIComponent(branchConfig.sucheParam)}` // TODO verifizieren
